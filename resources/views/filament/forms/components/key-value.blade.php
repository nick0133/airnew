...
<x-dynamic-component
    ...
    <x-filament::input.wrapper
        ...
        :attributes="\Filament\Support\prepare_inherited_attributes($getExtraAttributeBag())->class(['fi-fo-key-value'])">
        <div
            ...
            x-ignore
            {{ $attributes->merge($getExtraAlpineAttributes(), escape: false)->class(['divide-y divide-gray-200 dark:divide-white/10']) }}>
            <table
                ...
                <tbody
                    @if ($isReorderable) x-on:end.stop="reorderRows($event)"
                        x-sortable
                    ...
                    <template
                        ...
                        <tr
                            @if ($isReorderable) x-bind:x-sortable-item="row.key" @endif
