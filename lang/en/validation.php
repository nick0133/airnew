...
return [
    ...
    */
    ...
    'before_or_equal' => 'Поле :attribute должно быть датой, предшествующей :date или равной ней.',
    'между' => [
    ...
    */
    ...
    'custom' => [
        'inn' => [
            'numeric' => 'Поле ИНН должно быть числом',
        ],
        'ogrn' => [
            'numeric' => 'Поле ОГРН должно быть числом',
        ],
        'bik' => [
            'numeric' => 'Поле БИК должно быть числом',
        ],
        'chet' => [
            'numeric' => 'Поле Расчетный счет должно быть числом',
        ],
    ],
